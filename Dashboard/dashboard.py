...
all_df.drop(axis=0,subset=['order_approved_at'],inplace=True)
...
for column in datetime_columns:
    all_df[column] = pd.to_datetime(all_df[column],format='mixed', dayfirst=False)
...
ax[0].set_ylabel(None)
ax[0].set_xlabel("customer_id", fontsize=18)
...
ax[1].set_ylabel(None)
ax[1].set_xlabel("customer_id", fontsize=18)
...
ax[2].set_xlabel("customer_id", fontsize=18)
...
st.caption('Submission Dicoding 2024')
